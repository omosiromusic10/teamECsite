...
( 1, 1,"カルビ","かるび","カルビ 1人前(200g)",1,500,"./images","karubi.jpg",now(),"発売会社",0,now(),now()),
( 2, 2,"ロース","ろーす","ロース 1人前(200g)",1,500,"./images","ro-su.jpg",now(),"発売会社",0,now(),now()),
( 3, 3,"ホルモン","ほるもん","ホルモン 1人前(50g)",1,100,"./images","horumon.jpg",now(),"発売会社",0,now(),now()),
( 4, 4,"サーロイン","さーろいん","サーロイン 1人前(120g)",1,1000,"./images","sa-roin.jpg",now(),"発売会社",0,now(),now()),
( 5, 5,"豚バラ","ぶたばら","豚バラ 1人前(100g)",1,200,"./images","butabara.jpg",now(),"発売会社",0,now(),now()),
( 6, 6,"スペアリブ","すぺありぶ","スペアリブ 1人前(350g)",1,800,"./images","supearibu.jpg",now(),"発売会社",0,now(),now()),
( 7, 7,"鶏もも","とりもも","鶏もも 1人前(100g)",1,150,"./images","torimomo.jpg",now(),"発売会社",0,now(),now()),
( 8, 8,"ウインナー","ういんなー","ウインナー 1人前(150g)",1,300,"./images","so-se-zi.jpg",now(),"発売会社",0,now(),now()),
( 9, 9,"玉ねぎ串","たまねぎぐし","玉ねぎ串 (5本入) ",2,100,"./images","tamanegi.jpg",now(),"発売会社",0,now(),now()),
( 10, 10,"ピーマン","ぴーまん","ピーマン(1個)",2,40,"./images","pi-man.jpg",now(),"発売会社",0,now(),now()),
( 11, 11,"コーン","こーん","コーン(2本入)",2,300,"./images","toumorokoshi.jpg",now(),"発売会社",0,now(),now()),
( 12, 12,"エリンギ","えりんぎ","エリンギ(3個)",2,120,"./images","eringi.jpg",now(),"発売会社",0,now(),now()),
( 13, 13,"ジャガイモ","じゃがいも","ジャガイモ(1個)",2,40,"./images","zyagaimo.jpg",now(),"発売会社",0,now(),now()),
( 14, 14,"ニンジン","にんじん","ニンジン(1本)",2,40,"./images","ninzin.jpg",now(),"発売会社",0,now(),now()),
( 15, 15,"お手軽野菜セット","おてがるやさいせっと","お手軽野菜セット(2人前)",2,700,"./images","yasaiset.jpg",now(),"発売会社",0,now(),now()),
( 16, 16,"ギガ盛お肉セット","ぎがもりおにくせっと","ギガ盛お肉セット(4人前)",1,3000,"./images","niku4ninmae.jpg",now(),"発売会社",0,now(),now()),
( 17, 17,"BBQコンロ","ばーべきゅーこんろ","BBQコンロ",3,5000,"./images","bbqkonro.jpg",now(),"発売会社",0,now(),now()),
( 18, 18,"木炭","もくたん","木炭(3kg)",3,500,"./images",",mokutan2.jpg",now(),"発売会社",0,now(),now()),
( 19, 19,"テーブル","てーぶる","テーブル(1個)",3,5000,"./images","table.jpg",now(),"発売会社",0,now(),now()),
( 20, 20,"アームチェア","あーむちぇあ","アームチェア(1個)",3,2000,"./images","isu.jpg",now(),"発売会社",0,now(),now());
